...
import avatarSvg from '../../../assets/images/avatar/01.jpg';
...
function Header() {
    return (
        ...
        <div class="navbar-light header-sticky">

            <nav class="navbar navbar-expand-xl">
                <div class="container">

                    <a class="navbar-brand" href="index.html">
                        <img class="light-mode-item navbar-brand-item" src={logoSvg} alt="logo" />
                        <img class="dark-mode-item navbar-brand-item" src={logoLightSvg} alt="logo" />
                    </a>
                    ...
                    <ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                        ...
                        <li class="nav-item ms-3 dropdown">
                            ...
                            <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
                                <img class="avatar-img rounded-2" src={avatarSvg} alt="avatar" />
                            </a>
                                ...
                                <li class="px-3 mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="avatar me-3">
                                            <img class="avatar-img rounded-circle shadow" src={avatarSvg} alt="avatar" />
                                        </div>
                                        <div>
