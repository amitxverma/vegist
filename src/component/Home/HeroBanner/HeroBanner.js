...
import day4by11 from '../../../assets/images/category/hotel/4by3/11.jpg'
import day4by12 from '../../../assets/images/category/hotel/4by3/12.jpg'
            ...
            <div class="container">
                ...
                <div class="row g-4 g-lg-5">
                        ...
                        <div class="hstack gap-4 flex-wrap align-items-center">
                            ...
                            <a data-glightbox="" data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo" class="d-block">
                                ...
                                <div class="avatar avatar-md z-index-1 position-relative me-2">
                                    <img class="avatar-img rounded-circle" src={avatar12} alt="avatar"/>
                    ...
                    <div class="col-lg-6 position-relative">
                        ...
                        <img src={bgImage} class="rounded" alt=""/>
                            ...
                            <div class="vstack gap-5 align-items-center position-absolute top-0 start-0 d-none d-md-flex mt-4 ms-n3">
                                <img class="icon-lg shadow-lg border border-3 border-white rounded-circle" src={day4by11} alt="avatar"/>
                                    <img class="icon-xl shadow-lg border border-3 border-white rounded-circle" src={day4by12} alt="avatar"/>
                                    </div>
                            </div>
                    </div>
