...
export default function Login() {
    ...
    const HandleSubmit = async (e) => {
        ...
        let auth = data.filter((item) => (email === item.email && pass === item.password));
                                        ...
                                        <div className="p-4 p-sm-7">
                                            ...
                                            <form className="mt-4 text-start login-form">
                                                ...
                                                <div className="mb-3 position-relative">
                                                    ...
                                                    <input className="form-control fakepassword" type="password" name="userPass" id="psw-input" />
                                                ...
                                                <div><button type="submit" onClick={HandleSubmit} className="btn btn-primary w-100 mb-0">Login</button></div>
